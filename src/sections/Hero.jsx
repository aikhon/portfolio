  ...
  return (
    ...
    >
      ...
      <p className="text-lg leading-relaxed">
        A backend developer. A system administrator.<br></br>Moving to
        fullstack.<br></br> Open to new opportunities & challenges.
      </p>
      ...
      <div className="flex flex-wrap gap-2 items-center">
        ...
        <p className="text-[13px]">Available for Astana, Almaty, Atyrau</p>
        &bull;
