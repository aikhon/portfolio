// All icons live here so components stay readable. Each takes a className so
// the caller controls size; they draw in currentColor and inherit text colour.

// --- UI icons (stroked, Heroicons-style) ---
...
export function TelegramIcon({ className = 'size-4' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
